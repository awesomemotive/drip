...
use AwesomeMotive\Drip\Service\CampaignService;
use AwesomeMotive\Drip\Service\SubscriberService;
...
class Drip {
	...
	public function __construct( $accountId = false, $config = array() ) {
	...
	/**
	 * @param bool|int $accountId
	 */
	public function set_accountId( $accountId ) {
	...
	public function get_api( $class ) {
		$fq_class = '\\AwesomeMotive\\Drip\\Service\\' . $class;
